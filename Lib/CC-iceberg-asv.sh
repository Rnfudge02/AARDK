...
iceberg_build() {
    ...
    if [[ "$1" == "iceberg_asv_analysis" || "$1" == "iceberg-asv-analysis" ]]; then
        ...
        --build_arg PLATFORM=$2 --build_arg ENTER=asv-analysis-entrypoint --build_arg CONTROLLER=asv-AC \
        ...
        --build_arg PLATFORM=$2 --build_arg ENTER=asv-deployment-entrypoint --build_arg CONTROLLER=asv-DC \
